...
public class SetBtProfileActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_set_bt);
        mContext = this;
        ...
        if(mEnabled){
        	mEnabledProfile.setText(mEnabled?R.string.config_disable:R.string.config_enable);
        }else{
        	mEnabledProfile.setText(mEnabled?R.string.config_disable:R.string.config_enable);
        }
        ...
        Log.d("Seth Log", "SignalStrngth = " + mSignalStrength);
	...
	private void storeProfile()
	{
		...
		{
			//update the context value in database
			Log.d("Seth log","mSignalValues[" + mSignalValues[mSignalStrength] + "] = " + mSignalValues[mSignalStrength]);
			ContentValues values = new ContentValues();
			values.put(ProfileDatabaseHelper.BLUETOOTH_NAME, mDeviceName);
			values.put(ProfileDatabaseHelper.BLUETOOTH_RSSI, mSignalValues[mSignalStrength]);
			values.put(ProfileDatabaseHelper.PROFILE_VALUE, mProfileId);
			values.put(ProfileDatabaseHelper.ENABLED, mEnabled);
			mContext.getContentResolver().update(
			ProfileInfoProvider.CONTENT_URI_BT_PROFILES, values, 
			ProfileInfoProvider.BLUETOOTH_MAC + " = '" + mDeviceAddress +"'", null);	
		}else{
			...
			values.put(ProfileDatabaseHelper.PROFILE_VALUE, mProfileId);
			values.put(ProfileDatabaseHelper.ENABLED, mEnabled);
			mContext.getContentResolver().insert(ProfileInfoProvider.CONTENT_URI_BT_PROFILES, values);
		}
	}
}
