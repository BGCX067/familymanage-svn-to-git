...
//	private static final String MONTH_PAYCODE = "000000000000"; // 包月
	private static final String ITEMS_PAYCODE = "30000251403301"; // 单点多次
...
//		if (monthButton.getText().equals(getString(R.string.unsubscribe))) {
//			// 如果包月订购button上的文字为“退订”，则执行退订功能
//			showProgressDialog(nomalText);
//			purchase.unsubscribe(MONTH_PAYCODE, listener);
//			currentReq = 4;
//		} else {
//			// 如果包月订购button上的文字为“订购”，则执行订购功能
//			showProgressDialog(nomalText);
//			currentReq = 1;
