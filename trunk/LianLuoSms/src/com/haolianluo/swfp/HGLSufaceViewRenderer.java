...
//	private final int FRAMES = 50;
	...
	public void onDrawFrame(GL10 gl) {
		if(turn){
			turn = false;
//			SwfEngine.flips(mID, load(filename), "aaa", SwfEngine.getUniCodes(sms), FRAMES);
...
//		}
	 ...
	 * @param index ？？？
	 */
	public void turning(String moBanFileName,String ttfName,String sms){
		HLog.i("page turning!!!");
	...
	public void turning(String moBanFileName,String sms){
		this.turning(moBanFileName, "system/fonts/DroidSansFallback.ttf", sms);
	}
