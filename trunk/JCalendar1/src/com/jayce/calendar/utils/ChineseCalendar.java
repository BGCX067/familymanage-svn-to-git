...
public class ChineseCalendar {
	private static final String LOGNAME = ChineseCalendar.class.getSimpleName();
    ...
    static int[] sCalendarSolarToLundar(int iYear, int iMonth, int iDay)
    {
	    ...
	    int[] date = new int[3];
	    date[0] = iLYear;
	    date[1] = iLMonth > 9 ? iLMonth : iLMonth;
	    date[2] = iLDay > 9 ? iLDay : iLDay;
	    return date;
    }
