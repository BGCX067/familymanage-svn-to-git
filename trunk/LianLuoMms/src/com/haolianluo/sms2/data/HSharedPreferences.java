...
public class HSharedPreferences {
	...
	public boolean getFlashSet() {
		return readBoolean("flash_set");
	}
	
	public void setFlashSet() {
		writeBoolean("flash_set",true);
	}
	
	public void setTryOver(boolean over){
		writeBoolean("try_over",over);
	}

	public boolean getTryOver(){
		return readBoolean("try_over");
	}
	
	public void setNewListCount(String count){
		writeString("new_list_count",count);
	}

	public String getNewListCount(){
		return readString("new_list_count");
	}
	
	public void setNewListTime(String time){
		writeString("new_list_time",time);
	}

	public String getNewListTime(){
		return readString("new_list_time");
	}
	
	public void setNewListReqTime(String req_time){
		writeString("new_list_req_time",req_time);
	}

	public String getNewListReqTime(){
		return readString("new_list_req_time");
	}
	
	public boolean getLogout() {
		return readBoolean("sms_logout");
	}
	
	public void setLogout(boolean sms_logout) {
		writeBoolean("sms_logout", sms_logout);
	}
