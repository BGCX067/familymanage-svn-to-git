...
import com.haolianluo.sms2.ui.MessagingPreferenceActivity;
import com.haolianluo.sms2.ui.sms2.HTalkActivity;
import com.haolianluo.sms2.ui.sms2.HThreadActivity;
import com.haolianluo.sms2.util.AddressUtils;
...
public class MessagingNotification {
    ...
    public static final int MESSAGE_FAILED_NOTIFICATION_ID = 7891;
    public static final int DOWNLOAD_FAILED_NOTIFICATION_ID = 5311;
...
//            + " OR " + Mms.MESSAGE_TYPE + "=" + MESSAGE_TYPE_RETRIEVE_CONF + "))";
    ...
    private final static String NOTIFICATION_DELETED_ACTION =
            "com.haolianluo.sms2.NOTIFICATION_DELETED_ACTION";
...
//            Conversation.markAllConversationsAsSeen(context);
    ...
    private static final MmsSmsDeliveryInfo getSmsNewDeliveryInfo(Context context) {
        ...
        try {
            ...
            return new MmsSmsDeliveryInfo(String.format(context.getString(R.string.delivery_toast_body), address),timeMillis);
    ...
    private static final MmsSmsNotificationInfo getNewMessageNotificationInfo(
        ...
        clickIntent.putExtra("talk_activity", true);
        ...
        //把发送人传递到talk页，然后显示，再去后台查询数据库查看该名字是否有变化；
        clickIntent.putExtra("titleName", senderInfoName);
...
//            clickIntent.setType("vnd.android-dir/mms-sms");
            clickIntent.setClass(mContext, HThreadActivity.class);
            clickIntent.putExtra("notify_collect_close", true);
            Log.i("TAG", "-----a-----------a----------updateNotification");
        }
...
//            failedIntent = new Intent(context, ConversationList.class);
            //failedIntent = new Intent(context, HTalkActivity.class);
            //发送失败的信息大于一条的话就跳转到会话列表
            failedIntent = new Intent(context, HThreadActivity.class);
        } else {
            title = isDownload ?
