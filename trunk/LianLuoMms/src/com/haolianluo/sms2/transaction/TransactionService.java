...
//        return mConnMgr.getNetworkInfo(ConnectivityManager.TYPE_MOBILE_MMS).isAvailable();
    	return mConnMgr.getNetworkInfo(2).isAvailable();
    }
...
//                        	HSharedPreferences spf = new HSharedPreferences(TransactionService.this);
