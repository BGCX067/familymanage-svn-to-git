...
public class HUserSendCodeParser extends DataParser {
	...
	public HUserSendCodeParser(Context context, String phoneNum) {
		super(context);
		this.mContext = context;
		this.mPhoneNum = phoneNum;
	}

	public HResponseModel getSendCode() {
	...
	public String getBody() {
		return HConst.USER_SENDCODE(mContext, mPhoneNum);
	}
