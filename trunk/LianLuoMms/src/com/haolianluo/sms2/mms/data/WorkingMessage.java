...
import com.haolianluo.sms2.ExceedMessageSizeException;
import com.haolianluo.sms2.LogTag;
import com.haolianluo.sms2.MmsConfig;
import com.haolianluo.sms2.ResolutionException;
import com.haolianluo.sms2.UnsupportContentTypeException;
import com.haolianluo.sms2.data.HConst;
import com.haolianluo.sms2.mms.model.AudioModel;
import com.haolianluo.sms2.mms.model.ImageModel;
import com.haolianluo.sms2.mms.model.MediaModel;
import com.haolianluo.sms2.mms.model.SlideModel;
import com.haolianluo.sms2.mms.model.SlideshowModel;
import com.haolianluo.sms2.mms.model.TextModel;
import com.haolianluo.sms2.mms.model.VideoModel;
import com.haolianluo.sms2.transaction.MessageSender;
import com.haolianluo.sms2.transaction.MmsMessageSender;
...
import com.haolianluo.sms2.ui.SlideshowEditor;
...
//        }
        ...
        if (requiresMms()) {
            ...
            if (!TextUtils.isEmpty(content)) {
            	//编辑短信页面跳转到添加联系人页面的时候不保存草稿
            	if(HConst.markActivity != 10)
            	{	
    ...
    private void updateState(int state, boolean on, boolean notify) {
        ...
        if (notify) {
            if (oldState == 0 && mMmsState != 0) {
                ...
                //在有彩信草稿的情况下，转化为短信之后，要更新一下草稿。fix the bug 744
                saveDraft();
            }
        }
...
//        UserHappinessSignals.userAcceptedImeText(mContext);
        ...
        Cursor cursor = null;
        try {
            cursor = SqliteWrapper.query(mContext, mContentResolver,Mms.Outbox.CONTENT_URI, MMS_OUTBOX_PROJECTION, null, null, null);
            if (cursor != null) {
