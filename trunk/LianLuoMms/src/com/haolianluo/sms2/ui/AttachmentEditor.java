...
public class AttachmentEditor extends LinearLayout {
    ...
    public void update(WorkingMessage msg) throws IllegalArgumentException{
        hideView();
        mView = null;
    ...
    private SlideViewInterface createView() throws IllegalArgumentException {
    ...
    private SlideViewInterface createSlideshowView(boolean inPortrait) {
        ...
        updateSendButton();
        final ImageView playBtn = (ImageView) view.findViewById(
