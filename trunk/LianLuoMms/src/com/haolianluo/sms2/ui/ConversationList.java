 ...
 */
public class ConversationList extends SkinActivity 
...
//                            startActivity(intent);
                            Toast.makeText(ConversationList.this, "error", Toast.LENGTH_SHORT).show();
                        }
                    }, 2000);
                } else {
...
//        menu.add(0, MENU_COMPOSE_NEW, 0, R.string.menu_compose_new).setIcon(com.android.internal.R.drawable.ic_menu_compose);
        menu.add(0, MENU_COMPOSE_NEW, 0, R.string.menu_compose_new).setIcon(android.R.drawable.ic_menu_compass);
...
//        startActivity(ComposeMessageActivity.createIntent(this, 0));
    	startActivity(HTalkActivity.createIntent(this, 0));
    	//点击新建按钮进到talk页，send为true
...
//        startActivity(ComposeMessageActivity.createIntent(this, threadId));
        startActivity(HTalkActivity.createIntent(this, threadId));
        //点击会话列表项进到talk页, send为false
            ...
            MessageUtils.handleReadReport(mContext, mThreadId,
                ...
                public void run() {
                    ...
                    if (mThreadId == -1) {
                        ...
                        //fix the bug 633
                        //jayce comment this to fix 748
                        /*
                        if(HConst.markActivity != 1)
                        {
                        	mActivity.finish();
                        }*/
                    }
