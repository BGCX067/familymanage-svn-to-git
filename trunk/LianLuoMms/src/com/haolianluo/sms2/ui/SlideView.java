...
public class SlideView extends AbsoluteLayout implements
    ...
    private void initAudioInfoView(String name) {
        if (null == mAudioInfoView) {
            ...
            if (mConformanceMode) {
                mViewPort.addView(mAudioInfoView, new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
                        AUDIO_INFO_HEIGHT));
            } else {
    ...
    public void reset() {
        ...
        if (mScrollViewPort != null) {
            ...
            mScrollViewPort.setLayoutParams(
                    new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT, 0, 0));
        }
    ...
    public void enableMMSConformanceMode(int textLeft, int textTop,
        ...
        if (mScrollViewPort == null) {
            ...
            mScrollViewPort.addView(mViewPort, new FrameLayout.LayoutParams(LayoutParams.FILL_PARENT,
        ...
        for (View view : viewsByPosition.values()) {
            if (view instanceof VideoView) {
                mViewPort.addView(view, new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
