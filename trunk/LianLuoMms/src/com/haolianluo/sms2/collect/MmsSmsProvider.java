...
import android.provider.TelephonyMy.CanonicalAddressesColumns;
...
import android.provider.TelephonyMy.ThreadsColumns;
...
public class MmsSmsProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.haolianluo.sms2.collect-mms-sms";
    ...
    public boolean onCreate() {
        ...
        // mUseStrictPhoneNumberComparation =  getContext().getResources().getBoolean( com.android.internal.R.bool.config_use_strict_phone_number_comparation);
        return true;
    }
    ...
    public int delete(Uri uri, String selection,
        ...
        switch(URI_MATCHER.match(uri)) {
            ...
            case URI_CONVERSATIONS:
                ...
                CollectMmsSmsDatabaseHelper.updateAllThreads(db, null, null);
                break;
