...
import android.provider.TelephonyMy.Mms.Addr;
import android.provider.TelephonyMy.Mms.Part;
import android.provider.TelephonyMy.Mms.Rate;
...
public class MmsProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("collect-mms", null,         MMS_ALL);
        sURLMatcher.addURI("collect-mms", "#",          MMS_ALL_ID);
        sURLMatcher.addURI("collect-mms", "inbox",      MMS_INBOX);
        sURLMatcher.addURI("collect-mms", "inbox/#",    MMS_INBOX_ID);
        sURLMatcher.addURI("collect-mms", "sent",       MMS_SENT);
        sURLMatcher.addURI("collect-mms", "sent/#",     MMS_SENT_ID);
        sURLMatcher.addURI("collect-mms", "drafts",     MMS_DRAFTS);
        sURLMatcher.addURI("collect-mms", "drafts/#",   MMS_DRAFTS_ID);
        sURLMatcher.addURI("collect-mms", "outbox",     MMS_OUTBOX);
        sURLMatcher.addURI("collect-mms", "outbox/#",   MMS_OUTBOX_ID);
        sURLMatcher.addURI("collect-mms", "part",       MMS_ALL_PART);
        sURLMatcher.addURI("collect-mms", "#/part",     MMS_MSG_PART);
        sURLMatcher.addURI("collect-mms", "part/#",     MMS_PART_ID);
        sURLMatcher.addURI("collect-mms", "#/addr",     MMS_MSG_ADDR);
        sURLMatcher.addURI("collect-mms", "rate",       MMS_SENDING_RATE);
        sURLMatcher.addURI("collect-mms", "report-status/#",  MMS_REPORT_STATUS);
        sURLMatcher.addURI("collect-mms", "report-request/#", MMS_REPORT_REQUEST);
        sURLMatcher.addURI("collect-mms", "drm",        MMS_DRM_STORAGE);
        sURLMatcher.addURI("collect-mms", "drm/#",      MMS_DRM_STORAGE_ID);
        sURLMatcher.addURI("collect-mms", "threads",    MMS_THREADS);
        sURLMatcher.addURI("collect-mms", "scrapSpace", MMS_SCRAP_SPACE);
    }
