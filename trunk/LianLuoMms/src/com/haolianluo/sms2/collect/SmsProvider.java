...
package com.haolianluo.sms2.collect;
...
import android.provider.TelephonyMy.TextBasedSmsColumns;
...
public class SmsProvider extends ContentProvider {
    private static final Uri NOTIFICATION_URI = Uri.parse("content://com.haolianluo.sms2.collect-sms");
    private static final Uri ICC_URI = Uri.parse("content://com.haolianluo.sms2.collect-sms/icc");
    ...
    public boolean onCreate() {
        mOpenHelper = CollectMmsSmsDatabaseHelper.getInstance(getContext());
        return true;
    }
...
//                values.put(Sms.DATE, new Long(System.currentTimeMillis()));
            	values.put(Sms.DATE, HConst.collect_date);
            }
            values.put("_id", HConst.collect_id);
            ...
            if (((threadId == null) || (threadId == 0)) && (address != null)) {
                values.put(Sms.THREAD_ID, Threads.getCollectOrCreateThreadId(
                                   getContext(), address));
            }
        ...
        switch (match) {
            case SMS_ALL:
                ...
                if (count != 0) {
                	...
                	CollectMmsSmsDatabaseHelper.updateAllThreads(db, where, whereArgs);
                }
                break;
            ...
            case SMS_ALL_ID:
                try {
                    ...
                    count = CollectMmsSmsDatabaseHelper.deleteOneSms(db, message_id);
                } catch (Exception e) {
                    throw new IllegalArgumentException(
            ...
            case SMS_CONVERSATIONS_ID:
                ...
                count = db.delete(TABLE_SMS, where, whereArgs);
                CollectMmsSmsDatabaseHelper.updateThread(db, threadID);
                break;
...
//    }
    ...
    private void notifyChange(Uri uri) {
        ...
        cr.notifyChange(Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/conversations/"), null);
    }
    ...
    static {
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", null, SMS_ALL);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "#", SMS_ALL_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "inbox", SMS_INBOX);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "inbox/#", SMS_INBOX_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "sent", SMS_SENT);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "sent/#", SMS_SENT_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "draft", SMS_DRAFT);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "draft/#", SMS_DRAFT_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "outbox", SMS_OUTBOX);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "outbox/#", SMS_OUTBOX_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "undelivered", SMS_UNDELIVERED);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "failed", SMS_FAILED);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "failed/#", SMS_FAILED_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "queued", SMS_QUEUED);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "conversations", SMS_CONVERSATIONS);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "conversations/*", SMS_CONVERSATIONS_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "raw", SMS_RAW_MESSAGE);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "attachments", SMS_ATTACHMENT);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "attachments/#", SMS_ATTACHMENT_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "threadID", SMS_NEW_THREAD_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "threadID/*", SMS_QUERY_THREAD_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "status/#", SMS_STATUS_ID);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "sr_pending", SMS_STATUS_PENDING);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "icc", SMS_ALL_ICC);
        sURLMatcher.addURI("com.haolianluo.sms2.collect-sms", "icc/#", SMS_ICC);
