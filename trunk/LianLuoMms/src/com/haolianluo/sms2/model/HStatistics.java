...
public class HStatistics {
	 ...
	 * 桌面点击进入次数
	 */
	public static final String Z2_1 = "z2_1";
	/**
	 * 引导页面使用推荐模板次数
	 */
	public static final String Z2_2 = "z2_2";
	 ...
	 * 商店（右上）点击数
	 */
	public static final String Z3_1 = "z3_1";
	
	/***
	 * 首页长按查看点击数
	 */
	public static final String Z3_2 = "z3_2";
	
	/***
	 * 首页长按回复点击数
	 */
	public static final String Z3_3 = "z3_3";
	
	/***
	 * 首页长按删除点击数
	 */
	public static final String Z3_4 = "z3_4";
	
	/***
	 * 首页长按呼叫点击数
	 */
	public static final String Z3_5 = "z3_5";
	
	/***
	 * 首页长按添加联系人点击数
	 */
	public static final String Z3_6 = "z3_6";
	 ...
	 * 消息栏提醒开关
	 */
	public static final String Z5_20 = "z5_20";
	
	/**
	 * 快捷短信开关
	 */
	public static final String Z5_21 = "z5_21";
...
//	public static final String Z5_6 = "z5_6";
	 ...
	 * 点击进入短信详情的次数
	 */
	public static final String Z6_13 = "z6_13";
...
//	public static final String Z7_8 = "z7_8";
	 ...
	 * 阅读方式按钮点击
	 */
	public static final String Z7_9 = "z7_3";
	 ...
	 * 包月链接点击数
	 */
	public static final String Z8_5 = "z8_5";
	
	/**
	 * 包月成功次数
	 */
	public static final String Z8_6 = "z8_6";
	 ...
	 * 模板点击应用数
	 */
	public static final String Z10_6 = "z10_6";
	
	/**
	 * 模板点击查看数
	 */
	public static final String Z10_7 = "z10_7";
	...
	public String getDescribe(String zc, String data) {
		...
		if(zc.equals(Z1)){//飘窗
			...
			Cursor c = db.query(TABLE_NAME, new String[]{DATA1} , DB_CZ + " = '" + Z2_2 + "'", null, null, null, null);
			String resid = "0";
			if(c != null && c.getCount() > 0)
			{
				c.moveToNext();
			...
			rvalue = "2." + getCount(Z2_1, data) + "." + getCount(Z2_2, data) + "." + resid;
		}else if(zc.equals(Z3)){//快捷菜单（右上）点击数
			rvalue = "3." + getCount(Z3_1, data) + "." + getCount(Z3_2, data) + "." + getCount(Z3_3, data) + "." + getCount(Z3_4, data) + "." + getCount(Z3_5, data) + "." + getCount(Z3_6, data);
		
		}else if(zc.equals(Z4)){//撰写短信按钮点击数
			rvalue = "4." + getCount(Z4_1, data) + "." + getCount(Z4_2, data) + "." + getCount(Z4_3, data);
			...
			rvalue = "5." 
					...
					+ ".(0.0.0)"
					+ "." + getCount(Z5_4, data) 
					+ ".(" + getCount(Z5_4_1, data)
					+ "." + getCount(Z5_4_2, data) 
					+ "." + getCount(Z5_4_3, data) 
					+ "." + getCount(Z5_4_4, data) 
					+ "." + getCount(Z5_4_5, data) 
					+ ")." + getCount(Z5_5, data) 
					+ "." + strXX 
					+ "." + strDXZD 
					+ "." + strKJDX 
					...
					+ "." +  getCount(Z5_14,data) 
//					+ "." + getCount(Z5_16, data) 
//					+ "." + getCount(Z5_16_1, data) 
					+ "." + getCount(Z5_9, data) 
//					+ "(" 
//					+ getCount(Z5_9_1, data) 
//					+  "." + getCount(Z5_9_2, data)
//					+  "." + getCount(Z5_9_3, data) 
//					+ "." + getCount(Z5_9_4, data) 
//					+ ")";
					+ "." + getCount(Z5_16, data);
			
			
		}else if(zc.equals(Z6)){//短信泡泡界面
			//6.商店点击数.发送短信点击次数.添加收藏.转发.呼叫.复制文本.删除.添加联系人.点击进入短信详情的次数.
			rvalue = "6.0." + getCount(Z6_1, data) + "." + getCount(Z6_2, data) + "." + getCount(Z6_3, data) + "." + getCount(Z6_4, data)
			...
			rvalue = "8." + getCount(Z8_1, data) + "." + getCount(Z8_2, data) + "." + getCount(Z8_3, data) + "." + getCount(Z8_4, data)
					+ "." + getCount(Z8_5, data) + "." + getCount(Z8_6, data);
//			rvalue = "8." + getCount(Z8_1, data) + "." + getCount(Z8_2, data) + "." + getCount(Z8_3, data) + "." + getCount(Z8_4, data) 
...
//					+ "." + getCount(Z10_5, data) + ".(" + getCount(Z10_5_1, data) + "." + getCount(Z10_5_2, data) + ")." + getCount(Z10_5_3, data) + "]";
			...
			if(c != null && c.getCount() > 0)
			{
				...
				while(c.moveToNext())
				{
					...
					sb.append(".");
					sb.append(getCountForTen(Z10_6, data, c.getString(0)));
					sb.append(".(0.0).");
...
//					sb.append(").");
					...
					sb.append(getCountForTen(Z10_7, data, c.getString(0)));
			...
			//11.付费提示框确认点击数(模板ID).取消点击数(模板ID).计费短信弹出数
...
//		}
	...
	public void add(String zc, String d1, String d2, String d3) {
		...
		if (zc.equals(Z0_1)) {
			...
			if(zc.equals(Z10_1) || zc.equals(Z10_2) || zc.equals(Z10_3) || zc.equals(Z10_5) ||zc.equals(Z10_5_1) ||  zc.equals(Z10_5_2) || zc.equals(Z10_5_3) || zc.equals(Z10_6) || zc.equals(Z10_7)
