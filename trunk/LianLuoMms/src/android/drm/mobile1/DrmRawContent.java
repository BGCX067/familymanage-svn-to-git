...
public class DrmRawContent {
     ...
     */
    public DrmRawContent(InputStream inRawdata, int len, String mimeTypeStr) throws Exception, IOException {
        int mimeType;
        ...
        if (JNI_DRM_FAILURE == id)
            throw new Exception("nativeConstructDrmContent() returned JNI_DRM_FAILURE");
        ...
        if (JNI_DRM_FAILURE == rawType)
            throw new Exception("nativeGetDeliveryMethod() returned JNI_DRM_FAILURE");

        /* init the media content type. */
        mediaType = nativeGetContentType();
        if (null == mediaType)
            throw new Exception("nativeGetContentType() returned null");
    }
     ...
     */
    public int getContentLength(DrmRights rights) throws Exception {
        /**
        ...
        if (JNI_DRM_FAILURE == mediaLen)
            throw new Exception("nativeGetContentLength() returned JNI_DRM_FAILURE");
