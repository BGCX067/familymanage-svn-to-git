...
public class DrmRightsManager {
     ...
     */
    public synchronized DrmRights installRights(InputStream rightsData, int len, String mimeTypeStr) throws Exception, IOException {
        int mimeType = 0;
        ...
        if (JNI_DRM_FAILURE == res)
            throw new Exception("nativeInstallDrmRights() returned JNI_DRM_FAILURE");
     ...
     */
    public synchronized List<DrmRights> getRightsList() {
        List<DrmRights> rightsList = new ArrayList<DrmRights>();
