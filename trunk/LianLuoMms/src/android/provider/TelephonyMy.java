 ...
 * @hide
 */
public final class TelephonyMy {
    ...
    public interface BaseMmsColumns extends BaseColumns {
         ...
         * <P>Type: TEXT</P>
         */
        public static final String SEEN = "send";
    ...
    public static final class Threads implements ThreadsColumns {
        ...
        public static final Uri CONTENT_COLLECT_URI = Uri.withAppendedPath(MmsSms.CONTENT_COLLECT_URI, "conversations");
        
        public static final Uri OBSOLETE_THREADS_URI = Uri.withAppendedPath(CONTENT_URI, "obsolete");
        
        //收藏
        public static final Uri CONTENT_URI_COLLECT = Uri.withAppendedPath(MmsSms.CONTENT_URI_COLLECT, "conversations");
        public static final Uri OBSOLETE_THREADS_URI_COLLECT = Uri.withAppendedPath(CONTENT_URI_COLLECT, "obsolete");
        ...
        public static long getCollectOrCreateThreadId(Context context, String recipient) {
            Set<String> recipients = new HashSet<String>();

            recipients.add(recipient);
            return getCollectOrCreateThreadId(context, recipients);
        }
        ...
        public static long getCollectOrCreateThreadId(
                Context context, Set<String> recipients) {
            Uri.Builder uriBuilder = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/threadID").buildUpon();
    ...
    public static final class MmsSms implements BaseColumns {
        ...
        public static final Uri CONTENT_COLLECT_URI = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/");
        ...
        //收藏
        public static final Uri CONTENT_URI_COLLECT = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/");

        public static final Uri CONTENT_CONVERSATIONS_URI_COLLECT = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/conversations");

        public static final Uri CONTENT_FILTER_BYPHONE_URI_COLLECT = Uri.parse( "content://com.haolianluo.sms2.collect-mms-sms/messages/byphone");

        public static final Uri CONTENT_UNDELIVERED_URI_COLLECT = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/undelivered");

        public static final Uri CONTENT_DRAFT_URI_COLLECT = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/draft");

        public static final Uri CONTENT_LOCKED_URI_COLLECT = Uri.parse("content://com.haolianluo.sms2.collect-mms-sms/locked");
