...
public class AlarmReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context arg0, Intent arg1) {
		...
		Cursor c = arg0.getContentResolver().query(NotesProvider.CONTENT_URI_NOTES, new String[]{NotesDatabaseHelper.ALARM_TIME}, "_id = '" + _id + "'", null, null);
		...
		arg0.getContentResolver().update(NotesProvider.CONTENT_URI_NOTES, values, "_id = " + _id, null);
